    ...
    public partial class frmCategoria : Form
    {
        ...
        private void dgvdata_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                var w = Properties.Resources.ch2.Width;
                var h = Properties.Resources.ch2.Height;
                var x = e.CellBounds.Left + (e.CellBounds.Width - w) / 2;
                var y = e.CellBounds.Top + (e.CellBounds.Height - h) / 2;

                e.Graphics.DrawImage(Properties.Resources.ch2, new Rectangle(x, y, w, h));
                e.Handled = true;
            }
        }
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("¿Desea eliminar Categoria?", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    string mensaje = string.Empty;
                    Categoria obj = new Categoria()
                    {
